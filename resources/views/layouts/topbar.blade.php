                        ...
                        <li class="dropdown notification-list">
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg py-0">
                                ...
                                <div class="px-3" style="max-height: 300px;" data-simplebar>
                                    ...
                                    <h5 class="text-muted font-13 fw-normal mt-2">Hari ini</h5>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 text-truncate ms-2">
                                                    ...
                                                    <small class="noti-item-subtitle text-muted">Pengguna baru didaftar</small>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
                    ...
                    <div class="app-search dropdown">
                        <form>
                            <div class="input-group">
                                <input type="search" class="form-control dropdown-toggle" id="top-search">
                                <span class="mdi mdi-magnify search-icon"></span>
                                <button class="input-group-text btn btn-primary" type="submit">Cari</button>
                            </div>
                        </form>
                        ...
                        <div class="dropdown-menu dropdown-menu-animated dropdown-lg" id="search-dropdown">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                ...
                                <span>Pengesahan pengguna baharu</span>
                            </a>
